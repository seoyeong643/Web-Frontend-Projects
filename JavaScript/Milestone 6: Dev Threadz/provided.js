...
document.querySelector("#search-form").addEventListener("submit", (e) => {
  ...
  try {
    ...
    console.error(
      "Failed to filter products by search query! Check your getFilteredProducts logic in script.js"
    );
  }
});
...
document.querySelector("#currency-select").addEventListener("change", (e) => {
  ...
  try {
    ...
    console.error(
      "Failed to convert currency! Check your getConvertedPrices logic in script.js!"
    );
  }
});
